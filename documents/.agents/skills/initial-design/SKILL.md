...
- `docs/planning/feature-dependencies.md`
- 既存コード（存在する場合）
- `AGENTS.md` / 技術制約
...
- `docs/design/domain-boundaries.md`
- `docs/design/data-ownership.md`
- `docs/design/cross-cutting-concerns.md`
- `docs/design/technology-constraints.md`
- `docs/design/decisions/DEC-ARCH-*.md`
